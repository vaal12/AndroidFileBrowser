...
public class FileBrowserActivity extends Activity {
	...
	private void initializeButtons() {
		ImageButton upDirButton = (ImageButton) this
				.findViewById(R.id.upDirectoryButton);
		...
		// new Folder button
		Button newDirButton = (Button) this
				.findViewById(R.id.newDirectoryButton);
	...
	private void createDirectoryDialog() {
		...
		etNewName.setText(getString(R.string.default_directoryname)); // set
																		// directory
																		// name
																		// to
																		// some
				...
				.setPositiveButton(R.string.ok,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								String tempText = etNewName.getText()
										.toString();
								if (tempText.equals("")) {
									createDirectoryDialog();
									dialog.cancel();
	...
	private void updateCurrentDirectoryTextView() {
		...
		if (pathDirsList.size() == 0) {
			((ImageButton) this.findViewById(R.id.upDirectoryButton))
					.setEnabled(false);
			curDirString = "/";
		} else
			((ImageButton) this.findViewById(R.id.upDirectoryButton))
